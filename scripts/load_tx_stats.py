...
response = requests.get(
    "https://api.transifex.com/organizations/qgis/projects/qgis-documentation/",
    auth=("api", TX_TOKEN),
)
data = response.json()
# print(data)
...
translation_ratio = round(
    sum([value["percentage"] for value in language_rate.values()]) / nb_languages, 2
)
...
statsfile = path.join(
    path.dirname(__file__), "..", "docs/user_manual/preamble/translation_stats.rst"
)
