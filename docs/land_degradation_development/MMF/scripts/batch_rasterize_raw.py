...
class BatchRasterize(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterField('Fieldstorasterize', 'Fields to rasterize', type=QgsProcessingParameterField.Numeric, parentLayerParameterName='vector', allowMultiple=True, defaultValue=None, defaultToAllFields=True))
